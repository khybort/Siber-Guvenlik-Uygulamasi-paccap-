...
public class UygulamaProtokolIstatistigi extends IstatistikAlici
{
	...
	public UygulamaProtokolIstatistigi(){
		analizciler=JPaketAnalizciYukleyici.getAnalyzersOf(JPaketAnalizci.APPLICATION_LAYER);
	...
	public String getName(){
		return "Uygulama katmanı protokolü oranı";
	}
	...
	public long[] getValues(int index){
		switch(index){
			...
			case 1: //% of packets
				...
				if(toplamBoyut==0) return yuzdeler;
