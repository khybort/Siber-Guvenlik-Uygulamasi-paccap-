...
public class CizgiGraf extends JPanel
{
	...
	public CizgiGraf(String[] labels){
		this(labels,null,Integer.MAX_VALUE,Integer.MIN_VALUE,true,true);
	}
	
	CizgiGraf(String[] labels,long[][] values){
		this(labels,values,Integer.MAX_VALUE,Integer.MIN_VALUE,true,true);
	}
	
	CizgiGraf(String[] labels,long[][] values,long minValue,long maxValue){
		this(labels,values,minValue,maxValue,false,false);
	}
	
	CizgiGraf(String[] labels,long[][] values,long minValue,long maxValue,boolean autoMin,boolean autoMax){
		this.labels=labels;
	...
	public static void main(String[] args){
		...
		CizgiGraf l=new CizgiGraf(labels,null,0,10);
